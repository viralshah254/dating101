# Shubhmilan → Indian Matrimonial App: Codebase Review & Gap Analysis
...
- **Current product:** Shubhmilan — Flutter MVP frontend for a “sophisticated Indian-global dating app” (depth-first profiles, map discovery, circles, events, premium, verification).
...
| **Premium** | UI | Paywall: “Unlock more with Shubhmilan”, Premium (£9.99/mo), Boost pack; features like “See who likes you”, “Unlimited intros”, “Travel mode”, “Priority in discovery”, “Read receipts”. Restore purchases. |
...
| **Splash / tagline** | UI | Splash: “Shubhmilan”, “Sophisticated connections, globally.” Tagline: “Depth-first connections. No mindless swiping.” |
...
- “Shubhmilan” — product name (formerly saathi).
...
“We have a Flutter dating app (Shubhmilan) and want to turn it into an Indian matrimonial app that’s better than Shaadi.com and similar apps. Attached is a detailed review of the codebase (features, data models, flows, copy, and a checklist of what typical matrimony apps have).  
...
*Document generated from codebase review for the Shubhmilan → Indian matrimonial pivot. Update this file as the product and codebase evolve.*
