...
abstract class AppLocalizations {
  ...
  /// No description provided for @chatPrivacyFull.
  ///
  /// In en, this message translates to:
  /// **'Full access'**
  String get chatPrivacyFull;

  /// No description provided for @chatPrivacyFullBody.
  ///
  /// In en, this message translates to:
  /// **'Family can read the full conversation threads.'**
  String get chatPrivacyFullBody;

  /// No description provided for @chatPrivacyLabel.
  ///
  /// In en, this message translates to:
  /// **'Chat privacy'**
  String get chatPrivacyLabel;

  /// No description provided for @chatPrivacyPrivate.
  ///
  /// In en, this message translates to:
  /// **'Private'**
  String get chatPrivacyPrivate;

  /// No description provided for @chatPrivacyPrivateBody.
  ///
  /// In en, this message translates to:
  /// **'Your family cannot see any of your chats.'**
  String get chatPrivacyPrivateBody;

  /// No description provided for @chatPrivacySummaries.
  ///
  /// In en, this message translates to:
  /// **'Chat summaries'**
  String get chatPrivacySummaries;

  /// No description provided for @chatPrivacySummariesBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @creatingForBrother.
  ///
  /// In en, this message translates to:
  /// **'My brother'**
  String get creatingForBrother;

  /// No description provided for @creatingForBrotherSubtitle.
  ///
  /// In en, this message translates to:
  /// **'I\'m helping my brother find the right match.'**
  String get creatingForBrotherSubtitle;

  /// No description provided for @creatingForDaughter.
  ///
  /// In en, this message translates to:
  /// **'My daughter'**
  String get creatingForDaughter;

  /// No description provided for @creatingForDaughterSubtitle.
  ///
  /// In en, this message translates to:
  /// **'I\'m a parent searching for a match for her.'**
  String get creatingForDaughterSubtitle;

  /// No description provided for @creatingForMyself.
  ///
  /// In en, this message translates to:
  /// **'Myself'**
  String get creatingForMyself;

  /// No description provided for @creatingForMyselfSubtitle.
  ///
  /// In en, this message translates to:
  /// **'I\'m looking for a partner for myself.'**
  String get creatingForMyselfSubtitle;

  /// No description provided for @creatingForRelative.
  ///
  /// In en, this message translates to:
  /// **'A relative'**
  String get creatingForRelative;

  /// No description provided for @creatingForRelativeSubtitle.
  ///
  /// In en, this message translates to:
  /// **'I\'m helping a family member find the right match.'**
  String get creatingForRelativeSubtitle;

  /// No description provided for @creatingForScreenSubtitle.
  ///
  /// In en, this message translates to:
  /// **'We\'ll personalise the experience for you.'**
  String get creatingForScreenSubtitle;

  /// No description provided for @creatingForSister.
  ///
  /// In en, this message translates to:
  /// **'My sister'**
  String get creatingForSister;

  /// No description provided for @creatingForSisterSubtitle.
  ///
  /// In en, this message translates to:
  /// **'I\'m helping my sister find the right match.'**
  String get creatingForSisterSubtitle;

  /// No description provided for @creatingForSon.
  ///
  /// In en, this message translates to:
  /// **'My son'**
  String get creatingForSon;

  /// No description provided for @creatingForSonSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @familyInvolvementFamilyAssisted.
  ///
  /// In en, this message translates to:
  /// **'Family-assisted'**
  String get familyInvolvementFamilyAssisted;

  /// No description provided for @familyInvolvementJointDecision.
  ///
  /// In en, this message translates to:
  /// **'Joint decision'**
  String get familyInvolvementJointDecision;

  /// No description provided for @familyInvolvementQuestion.
  ///
  /// In en, this message translates to:
  /// **'Family Involvement'**
  String get familyInvolvementQuestion;

  /// No description provided for @familyInvolvementSelfManaged.
  ///
  /// In en, this message translates to:
  /// **'Self-managed'**
  String get familyInvolvementSelfManaged;
  ...
  /// No description provided for @familyModeAssisted.
  ///
  /// In en, this message translates to:
  /// **'Family-assisted mode'**
  String get familyModeAssisted;

  /// No description provided for @familyModeAssistedBody.
  ///
  /// In en, this message translates to:
  /// **'Your family can browse, shortlist, and add notes.'**
  String get familyModeAssistedBody;

  /// No description provided for @familyModeHidden.
  ///
  /// In en, this message translates to:
  /// **'Hidden-from-family mode'**
  String get familyModeHidden;

  /// No description provided for @familyModeHiddenBody.
  ///
  /// In en, this message translates to:
  /// **'Your profile is hidden from people you flag as family.'**
  String get familyModeHiddenBody;

  /// No description provided for @familyModeJoint.
  ///
  /// In en, this message translates to:
  /// **'Joint decision mode'**
  String get familyModeJoint;

  /// No description provided for @familyModeJointBody.
  ///
  /// In en, this message translates to:
  /// **'Both you and a parent must approve before an interest is sent.'**
  String get familyModeJointBody;

  /// No description provided for @familyModeLabel.
  ///
  /// In en, this message translates to:
  /// **'Family mode'**
  String get familyModeLabel;

  /// No description provided for @familyModeSelf.
  ///
  /// In en, this message translates to:
  /// **'Self mode'**
  String get familyModeSelf;

  /// No description provided for @familyModeSelfBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @handoverBodyParent.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @handoverGenerateLink.
  ///
  /// In en, this message translates to:
  /// **'Generate handover link'**
  String get handoverGenerateLink;

  /// No description provided for @handoverLinkExpiry.
  ///
  /// In en, this message translates to:
  /// **'Link expires in 7 days.'**
  String get handoverLinkExpiry;

  /// No description provided for @handoverSuccessBody.
  ///
  /// In en, this message translates to:
  /// **'This profile is now yours. Your family stays connected as a family member.'**
  String get handoverSuccessBody;

  /// No description provided for @handoverSuccessTitle.
  ///
  /// In en, this message translates to:
  /// **'Profile transferred!'**
  String get handoverSuccessTitle;

  /// No description provided for @handoverTitleParent.
  ///
  /// In en, this message translates to:
  /// **'Invite them to take over'**
  String get handoverTitleParent;
  ...
  /// No description provided for @marriageIntentSection.
  ///
  /// In en, this message translates to:
  /// **'Marriage Intent'**
  String get marriageIntentSection;

  /// No description provided for @marriageIntentSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Tell matches about your timeline and intentions.'**
  String get marriageIntentSubtitle;

  /// No description provided for @marriageTimeline1to2years.
  ///
  /// In en, this message translates to:
  /// **'1–2 years'**
  String get marriageTimeline1to2years;

  /// No description provided for @marriageTimeline3to6.
  ///
  /// In en, this message translates to:
  /// **'3–6 months'**
  String get marriageTimeline3to6;

  /// No description provided for @marriageTimeline6to12.
  ///
  /// In en, this message translates to:
  /// **'6–12 months'**
  String get marriageTimeline6to12;

  /// No description provided for @marriageTimelineExploring.
  ///
  /// In en, this message translates to:
  /// **'Still exploring'**
  String get marriageTimelineExploring;

  /// No description provided for @marriageTimelineQuestion.
  ///
  /// In en, this message translates to:
  /// **'Marriage Timeline'**
  String get marriageTimelineQuestion;

  /// No description provided for @marriageTimelineSubtitle.
  ///
  /// In en, this message translates to:
  /// **'When are you looking to get married?'**
  String get marriageTimelineSubtitle;
  ...
  /// No description provided for @paywallStorePricesHint.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @relocationAbroadOk.
  ///
  /// In en, this message translates to:
  /// **'Open to abroad'**
  String get relocationAbroadOk;

  /// No description provided for @relocationFlexible.
  ///
  /// In en, this message translates to:
  /// **'Flexible'**
  String get relocationFlexible;

  /// No description provided for @relocationSameCity.
  ///
  /// In en, this message translates to:
  /// **'Same city'**
  String get relocationSameCity;

  /// No description provided for @relocationSameCountry.
  ///
  /// In en, this message translates to:
  /// **'Same country'**
  String get relocationSameCountry;

  /// No description provided for @relocationWillingnessQuestion.
  ///
  /// In en, this message translates to:
  /// **'Relocation preference'**
  String get relocationWillingnessQuestion;
  ...
  /// No description provided for @wizardStepBackground.
  ///
  /// In en, this message translates to:
  /// **'Background'**
  String get wizardStepBackground;

  /// No description provided for @wizardStepCreatingFor.
  ///
  /// In en, this message translates to:
  /// **'Who is this profile for?'**
  String get wizardStepCreatingFor;

  /// No description provided for @wizardStepInterests.
  ///
  /// In en, this message translates to:
  /// **'Interests'**
  String get wizardStepInterests;

  /// No description provided for @wizardStepLifestyle.
  ///
  /// In en, this message translates to:
  /// **'Lifestyle'**
  String get wizardStepLifestyle;

  /// No description provided for @wizardStepLifestyleHoroscope.
  ///
  /// In en, this message translates to:
  /// **'Lifestyle & Horoscope'**
  String get wizardStepLifestyleHoroscope;

  /// No description provided for @wizardStepLookingFor.
  ///
  /// In en, this message translates to:
  /// **'Looking for'**
  String get wizardStepLookingFor;
  ...
  /// No description provided for @wizardStepYou.
  ///
  /// In en, this message translates to:
  /// **'You'**
  String get wizardStepYou;
