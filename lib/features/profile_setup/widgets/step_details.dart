...
const _degreeOptions = [
  'High School', 'Diploma', 'Bachelors', 'Masters', 'MBA', 'PhD',
  'Medical (MBBS/MD)', 'Engineering (B.Tech/M.Tech)', 'CA/CFA', 'Law (LLB/LLM)', 'Other',
];

/// Degrees that do not show university/college field (e.g. High School, Diploma).
bool _showsInstitution(String? degree) => educationEntryShowsInstitution(degree);
...
const _scoreTypesByCountry = <String, List<String>>{
  ...
  'UK': ['First-class honours', 'Upper second (2:1)', 'Lower second (2:2)', 'Third class', 'Pass'],
  'US': ['GPA 3.5 – 4.0', 'GPA 3.0 – 3.5', 'GPA 2.5 – 3.0', 'GPA 2.0 – 2.5', 'Pass'],
  'Other': ['Percentage', 'Grade', 'Pass', 'Not specified'],
};

/// Career step: searchable options.
const _occupationOptions = [
  'Software Engineer', 'Doctor', 'Teacher', 'Engineer', 'Accountant', 'Lawyer', 'Architect',
  'CA / Chartered Accountant', 'Consultant', 'Manager', 'Business Owner', 'Government Employee',
  'Banking / Finance', 'Marketing', 'HR', 'Designer', 'Data Scientist', 'Professor', 'Researcher',
  'Nurse', 'Pharmacist', 'Veterinarian', 'Journalist', 'Civil Servant', 'Defence', 'Other',
];
const _companyOptions = [
  'Self-employed', 'Startup', 'Google', 'Microsoft', 'Amazon', 'TCS', 'Infosys', 'Wipro', 'HCL',
  'Accenture', 'Cognizant', 'IBM', 'Capgemini', 'Deloitte', 'EY', 'KPMG', 'PwC', 'Government',
  'PSU', 'Reliance', 'Tata', 'Mahindra', 'ICICI', 'HDFC', 'State Bank', 'Other',
];
const _workLocationOptions = [
  'Remote', 'Abroad', 'Mumbai', 'Delhi', 'Bangalore', 'Hyderabad', 'Chennai', 'Kolkata', 'Pune',
  'Ahmedabad', 'Jaipur', 'Chandigarh', 'Kochi', 'Indore', 'Lucknow', 'Nagpur', 'Other',
];

/// Annual income options: India (LPA) vs rest of world (USD), based on locale.
const _incomeOptionsIndia = [
  'Not specified', 'Below 3 LPA', '3-5 LPA', '5-10 LPA', '10-20 LPA', '20-50 LPA', '50 LPA+', 'Abroad salary',
];
const _incomeOptionsUSD = [
  'Not specified', 'Below \$30k', '\$30k–\$50k', '\$50k–\$75k', '\$75k–\$100k', '\$100k–\$150k', '\$150k+', 'Abroad salary',
];
...
const _motherTongueAndLanguageOptions = [
  'Hindi', 'Bengali', 'Telugu', 'Marathi', 'Tamil', 'Urdu', 'Gujarati', 'Kannada', 'Malayalam', 'Punjabi',
  'Odia', 'Assamese', 'Kashmiri', 'Sindhi', 'Konkani', 'Nepali', 'Sanskrit', 'English', 'Other',
];

/// Parent age dropdown: Deceased + ages 35–95.
final _parentAgeOptions = ['Deceased', ...List.generate(61, (i) => '${35 + i}')];

/// Household income in India — Rs (LPA).
const _householdIncomeLPA = [
  'Not specified', 'Below Rs 5 LPA', 'Rs 5-10 LPA', 'Rs 10-15 LPA', 'Rs 15-20 LPA', 'Rs 20-50 LPA', 'Rs 50 LPA+',
];

/// Household income in USD (outside India).
const _householdIncomeUSD = [
  'Not specified', 'Below \$50k', '\$50k–\$100k', '\$100k–\$150k', '\$150k–\$200k', '\$200k–\$500k', '\$500k+',
];

/// Gotra options (searchable dropdown) — major gotras and common variants.
const _gotraOptions = [
  'Agastya', 'Angirasa', 'Asita', 'Atri', 'Atreya', 'Aurva', 'Avatsara', 'Barhaspatya', 'Bharadwaj', 'Bharadvaja',
  'Bhargava', 'Bhrigu', 'Cyavana', 'Daivala', 'Daivarata', 'Daivodasa', 'Dairghatamasa', 'Gargya', 'Gathina',
  'Gautam', 'Gautama', 'Gartsamada', 'Jamadagni', 'Jamadagnya', 'Kashyap', 'Kashyapa', 'Kaushik', 'Kaushika',
  'Kakshivata', 'Kanva', 'Kautsa', 'Maitravaruna', 'Mandhata', 'Maudgalya', 'Parasharya', 'Partha', 'Sankritya',
  'Sandilya', 'Shandilya', 'Shaunaka', 'Shaktya', 'Upamanyu', 'Aupamanyava', 'Vashistha', 'Vasishtha', 'Vatsa',
  'Vainya', 'Vishwamitra', 'Vaishvamitra', 'Madhucchandasa', 'Ambarisha', 'Other', 'Don\'t know',
];
...
const _parentOccupationOptions = [
  'Homemaker', 'Teacher', 'Professor', 'Govt. employee', 'Private sector', 'Business', 'Self-employed',
  'Doctor', 'Engineer', 'Lawyer', 'CA / Accountant', 'Banking / Finance', 'IT / Software', 'Nurse',
  'Retired', 'Not working', 'Agriculture', 'Defence', 'Other',
];
...
String? _countryToGradingSystem(String? country) {
  ...
  if (c == 'united kingdom' || c == 'uk' || c == 'england' || c == 'scotland' || c == 'wales' || c == 'northern ireland') return 'UK';
  if (c == 'united states' || c == 'united states of america' || c == 'usa' || c == 'us') return 'US';
      ...
      child: Column(
        ...
        children: [
          ...
          ...formData.educationEntries.asMap().entries.map((entry) {
            ...
            return Padding(
              ...
              child: _EducationEntryRow(
                entry: e,
                onDegreeChanged: (v) { e.degree = v; onChanged(); },
                ...
                onGraduationYearChanged: (v) { e.graduationYear = v; onChanged(); },
                onScoreCountryChanged: (v) {
                  e.scoreCountry = v;
                  e.scoreType = null;
                  onChanged();
                },
                onScoreTypeChanged: (v) { e.scoreType = v; onChanged(); },
          ...
          _MultilineField(
            ...
            onChanged: (v) { formData.aboutEducation = v.isEmpty ? null : v; onChanged(); },
          ),
...
class _EducationEntryRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final scoreTypes = entry.scoreCountry != null && _scoreTypesByCountry.containsKey(entry.scoreCountry)
...
List<int> get _graduationYears => List.generate(70, (i) => DateTime.now().year - i);
              ...
              children: [
                Text(
                  ...
                  style: AppTypography.bodyLarge.copyWith(
                    color: value != null ? onSurface : onSurface.withValues(alpha: 0.5),
                  ),
                ),
                const Spacer(),
                Icon(Icons.arrow_drop_down, color: onSurface.withValues(alpha: 0.5)),
              ],
            ),
          ),
        ),
    ...
    return SafeArea(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            const SizedBox(height: 8),
            Container(width: 40, height: 4, decoration: BoxDecoration(color: onSurface.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(2))),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
              child: Row(
                children: [
                  TextButton(onPressed: onClear, child: const Text('—')),
                  const Spacer(),
                  Text(AppLocalizations.of(context)!.graduationYear, style: AppTypography.titleSmall.copyWith(color: onSurface)),
                  const Spacer(),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return ListTile(
                    title: Text('$y', style: AppTypography.bodyLarge.copyWith(color: onSurface)),
...
class _SearchableDegreeFieldState extends State<_SearchableDegreeField> {
  ...
  void initState() {
    ...
    _focusNode.addListener(() => setState(() => _showList = _focusNode.hasFocus));
  }
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                return ListTile(
                  title: Text(
                    opt,
                    style: AppTypography.bodyMedium.copyWith(color: onSurface, fontWeight: FontWeight.w500),
                  ),
                  onTap: () {
                    _ctrl.text = opt;
                    _focusNode.unfocus();
...
class _MultiSelectSearchField extends StatefulWidget {
  ...
  @override
  State<_MultiSelectSearchField> createState() => _MultiSelectSearchFieldState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          widget.label,
          style: AppTypography.labelMedium.copyWith(color: onSurface.withValues(alpha: 0.7)),
        ),
        const SizedBox(height: 6),
        TextField(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              return ListTile(
                ...
                trailing: isSelected ? Icon(Icons.check_circle, size: 20, color: accent) : null,
                onTap: () => _toggle(opt),
              );
            },
          ),
    ...
    return Column(
      ...
      children: [
        ...
        if (widget.subtitle != null && widget.subtitle!.isNotEmpty) ...[
          ...
          Text(
            widget.subtitle!,
            style: AppTypography.bodySmall.copyWith(color: onSurface.withValues(alpha: 0.5)),
          ),
        ],
        const SizedBox(height: 6),
        TextField(
...
class _FamilyLocationSearchField extends StatefulWidget {
  ...
  @override
  State<_FamilyLocationSearchField> createState() => _FamilyLocationSearchFieldState();
}

class _FamilyLocationSearchFieldState extends State<_FamilyLocationSearchField> {
  late final TextEditingController _ctrl;
  Timer? _debounce;
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: widget.hint,
            prefixIcon: Icon(Icons.location_on_outlined, size: 20, color: onSurface.withValues(alpha: 0.4)),
            filled: true,
            fillColor: Theme.of(context).colorScheme.surfaceContainerHighest,
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
            contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
            ...
            children: [
              ...
              Builder(
                builder: (context) {
                  ...
                  final incomeOptions = isIndia ? _incomeOptionsIndia : _incomeOptionsUSD;
              ...
              const SizedBox(height: 8),
              _ChipRow(
                options: [l.sectorPrivate, l.sectorGovernment, l.sectorPSU, l.sectorBusiness, l.sectorOther],
                selected: formData.sector,
                onSelected: (v) { formData.sector = v; onChanged(); },
              ),
              const SizedBox(height: 16),
              _SearchableSelectField(
              ...
              _MultilineField(
                ...
                onChanged: (v) { formData.aboutCareer = v.isEmpty ? null : v; onChanged(); },
              ),
            ],
          ),
          const SizedBox(height: 40),
            ...
            children: [
              _FamilyLocationSearchField(
                ...
                onSelected: (displayName, country) {
                  final countryChanged = formData.familyBasedOutOfCountry != country;
              ...
              _DropdownField(
                ...
                items: formData.familyBasedOutOfCountry != null && formData.familyBasedOutOfCountry != 'India'
                    ? _householdIncomeUSD
                    : _householdIncomeLPA,
                onChanged: (v) { formData.householdIncome = v; onChanged(); },
              ),
              const SizedBox(height: 16),
              ...
              _SearchableSelectField(
                ...
                onChanged: (v) { formData.motherAge = v; onChanged(); },
              ),
              const SizedBox(height: 16),
              _SearchableSelectField(
                ...
                options: _parentAgeOptions,
                onChanged: (v) { formData.fatherAge = v; onChanged(); },
              ),
              const SizedBox(height: 16),
              _SearchableSelectField(
                ...
                onChanged: (v) { formData.motherOccupation = v; onChanged(); },
              ),
              const SizedBox(height: 16),
              _SearchableSelectField(
                ...
                options: _parentOccupationOptions,
                onChanged: (v) { formData.fatherOccupation = v; onChanged(); },
              ),
              const SizedBox(height: 16),
          ...
          _DetailCard(
            ...
            children: [
              ...
              _TimeOfBirthField(
                ...
                onChanged: (v) { formData.birthTime = v; onChanged(); },
              ),
              const SizedBox(height: 16),
              _FamilyLocationSearchField(
...
class _TimeOfBirthField extends StatelessWidget {
  ...
  static TimeOfDay? _parse(String? s) {
    ...
    if (m != null) {
      ...
      if (pm && h < 12) h += 12;
      if (!pm && h == 12) h = 0;
      if (h >= 0 && h <= 23 && min >= 0 && min <= 59) return TimeOfDay(hour: h, minute: min);
    }
        ...
        InkWell(
          ...
          child: InputDecorator(
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
              contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
              suffixIcon: Icon(Icons.schedule, size: 20, color: onSurface.withValues(alpha: 0.4)),
            ),
            child: Text(
              value?.isNotEmpty == true ? value! : '',
              style: AppTypography.bodyMedium.copyWith(
                color: value?.isNotEmpty == true ? onSurface : onSurface.withValues(alpha: 0.5),
              ),
            ),
          ),
        ),
